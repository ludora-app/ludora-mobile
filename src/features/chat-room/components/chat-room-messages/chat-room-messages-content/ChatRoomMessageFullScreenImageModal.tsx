  ...
  return (
    <Dialog>
      <DialogContent visible={isOpen} setVisible={setIsOpen} container={false}>
        ...
        <View className="bg-main w-full h-full">
          <View className="w-full justify-between items-center flex-row px-4 py-2 absolute top-0 left-0 z-10">
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View className="w-screen h-screen justify-center items-center">
                <Image source={{ uri: item }} className="bg-white w-[90%] aspect-[1/1] rounded-lg" resizeMode="cover" />
              </View>
            )}
          />
        </View>
