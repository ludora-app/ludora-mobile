...
import type {
  ...
  MyFieldResponseData,
  MyFieldResponseDataStatus,
} from '@/api/generated/model'

import { FieldCard } from '@/components/ui/field-card'

interface MyFieldCardProps {
  item: MyFieldResponseData
}

function mapMyFieldToFieldDto(item: MyFieldResponseData): FieldResponseDto {
  return {
...
const STATUS_LABEL_KEYS: Record<MyFieldResponseDataStatus, string> = {
  APPROVED: 'my_fields.status_approved',
  PENDING: 'my_fields.status_pending',
  REJECTED: 'my_fields.status_rejected',
}

const COLORS_VARIANTS: Record<MyFieldResponseDataStatus, ChipProps["colorVariant"]> = {
  APPROVED: 'success',
  PENDING: "primary",
  REJECTED: 'error',
}
