...
import CreateSessionStep1Part1 from '../components/create-session-steps/create-session-step-1/create-session-step-1-part-1/create-session-step-1-part-1.component';
import CreateSessionStep1Part2 from '../components/create-session-steps/create-session-step-1/create-session-step-1-part-2/create-session-step-1-part-2.component';
import CreateSessionStep1Part3 from '../components/create-session-steps/create-session-step-1/create-session-step-1-part-3/create-session-step-1-part-3.component';
import CreateSessionStep1Part4 from '../components/create-session-steps/create-session-step-1/create-session-step-1-part-4/create-session-step-1-part-4.component';
...
export default function CreateSessionStep1() {
  ...
  const reset = () => {
    resetCreateSessionStore();
    resetSessionFiltersStore();
  };
