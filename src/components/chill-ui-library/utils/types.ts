...
import { textColorVr, textPositionVr, textSizeVr, textTypeVr } from '../components/string/utils/styleVariants';
import { InputProps } from '@chillui/ui';
...
export type FormInputProps = Omit<UseControllerProps<FieldValues>, 'defaultValue'> & InputProps;
