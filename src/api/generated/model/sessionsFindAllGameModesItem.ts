...
export type SessionsFindAllGameModesItem =
  (typeof SessionsFindAllGameModesItem)[keyof typeof SessionsFindAllGameModesItem];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SessionsFindAllGameModesItem = {
  ONE_V_ONE: 'ONE_V_ONE',
  TWO_V_TWO: 'TWO_V_TWO',
