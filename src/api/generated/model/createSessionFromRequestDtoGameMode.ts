 ...
 */
export type CreateSessionFromRequestDtoGameMode =
  (typeof CreateSessionFromRequestDtoGameMode)[keyof typeof CreateSessionFromRequestDtoGameMode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateSessionFromRequestDtoGameMode = {
  ONE_V_ONE: 'ONE_V_ONE',
  TWO_V_TWO: 'TWO_V_TWO',
