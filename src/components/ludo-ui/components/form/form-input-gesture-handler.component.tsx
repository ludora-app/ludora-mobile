...
import InputGestureHandler from '../input/input-gesture-handler.component';

const FormInputGestureHandler = forwardRef<any, FormInputProps<any>>((props, ref) => {
  const {
    className,
    control,
    hasClearIcon,
...
FormInputGestureHandler.displayName = "FormInputGestureHandler"

export default FormInputGestureHandler;
