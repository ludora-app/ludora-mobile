...
type ChatRoomUserProfileReportConfirmDialogProps = {
  firstname: string;
  lastname: string;
...
export default function ChatRoomUserProfileReportConfirmDialog(props: ChatRoomUserProfileReportConfirmDialogProps) {
  const {
    firstname,
    handleConfirmReport,
    isLoadingReport,
  ...
  return (
    <DialogConfirm
      ...
      source="chat_room_user_profile_report_user"
