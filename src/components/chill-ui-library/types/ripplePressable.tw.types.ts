...
import { PressableProps as PressableGestureHandlerProps } from 'react-native-gesture-handler';
...
export type RipplePressableGestureHandlerProps = Omit<PressableGestureHandlerProps, 'style'> & {
  className?: string;
  /** Whether the component is disabled */
  disabled?: boolean;
  /** Color of the ripple effect */
