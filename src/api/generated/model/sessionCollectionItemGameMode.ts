 ...
 * Session game mode
 */
export type SessionCollectionItemGameMode =
  (typeof SessionCollectionItemGameMode)[keyof typeof SessionCollectionItemGameMode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SessionCollectionItemGameMode = {
  ONE_V_ONE: 'ONE_V_ONE',
  TWO_V_TWO: 'TWO_V_TWO',
